...
public class Program {
    ...
    */
    ...
    public static void main(String[] args) throws IllegalAccessException {
        ...
        // Домашняя работа - формирование запроса на удаление данных из таблицы
        String deleteFromTable = queryBuilder.buildDeleteQuery(Employee.class, pk);
        System.out.println("Delete STR: " + deleteFromTable);
    }
